...
public class PLAYER_SET_MOVEMENT_SPEED extends Action {
    @Override
    public Object execute(Selector selector, Object[] args) {
        for (Player player : selector.players) {
            player.setWalkSpeed(parseFloat(args[0].toString()));
        }
        return null;
    }
    ...
    public SelectionIcon getIcon() {
        return new SelectionIcon(Material.GOLDEN_BOOTS,this);
    }
