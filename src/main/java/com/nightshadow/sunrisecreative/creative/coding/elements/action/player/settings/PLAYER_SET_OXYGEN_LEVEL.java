...
public class PLAYER_SET_OXYGEN_LEVEL extends Action {

    @Override
    public Object execute(Selector selector, Object[] args) {
        for (Player player : selector.players) {
            player.setRemainingAir(parseInt(args[0].toString()));
        }
        return null;
    }
    ...
    public SelectionIcon getIcon() {
        return new SelectionIcon(Material.GLASS_BOTTLE,this).experimental();
    }
