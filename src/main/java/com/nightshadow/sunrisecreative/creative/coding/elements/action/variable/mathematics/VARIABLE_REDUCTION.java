...
public class VARIABLE_REDUCTION extends Action {
    @Override
    public Object execute(Selector selector, Object[] args) {
        ...
        if (var.getType() == ValueType.NUMBER) {
            var.setValue(parseDouble(args[2].toString()) - parseDouble(args[1].toString()));
        }
        return null;
    }
    ...
    public List<ValueType> getArguments() {
        return List.of(ValueType.VARIABLE, ValueType.NUMBER, ValueType.NUMBER);
    }
