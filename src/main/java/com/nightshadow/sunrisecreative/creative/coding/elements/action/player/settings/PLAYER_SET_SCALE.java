...
public class PLAYER_SET_SCALE extends Action {
    @Override
    public Object execute(Selector selector, Object[] args) {
        for (Player player : selector.players) {
            ...
            player.getAttribute(Attribute.SCALE).setBaseValue(parseDouble(args[0].toString()));
        }
        return null;
    }
    ...
    public SelectionIcon getIcon() {
        return new SelectionIcon(Material.SLIME_BLOCK,this);
    }
